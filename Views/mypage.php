...
<div class='indexwrapper'>   
    <div class="indexwrap">
        ...
        <button type="button" class="btn btn-light text-right pageback" style="font-size: 30px; width:350px;"><a href="myiine.php">myいいねページへ</a></button>
        <button type="button" class="btn btn-info text-right pageback" style="font-size: 30px; width:200px;"><a href="index.php">トップに戻る</a></button>
