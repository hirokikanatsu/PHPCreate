...
<div class='indexwrapper'>   
    <div class="indexwrap">
                ...
                <tbody>
                    <?php $i=0; while($i < count($result)): ?>    
                                <tr>   
                                    ...
                                    <td><a href='deleteend.php?id=<?php echo $result[$i]['id'];?>'>削除</a></td>                                
                                </tr>
                        <?php  $i++ ?>        
                    <?php endwhile; ?>
        ...
        <button type="button" class="btn btn-info text-right pageback" style="font-size: 30px;"><a href="index.php">戻る</a></button>
    </div>
